...
const AdvancedTrainingPrograms = () => {
    const [loading, setLoading] = useState(true);
    const [advancedTrainingPrograms, setAdvancedTrainingPrograms] = useState([]);
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                // Filter for advanced programs
                const advancedPrograms = availablePrograms.filter(program => program.fitnessLevel === 'Advanced');

                // Set states
                setBookedPrograms(bookedProgramIds);
                setAdvancedTrainingPrograms(advancedPrograms);
            } catch (error) {
    ...
    const filteredPrograms = advancedTrainingPrograms.filter(program =>
    ...
    return (
         <Box padding={3}>
            ...
            <TextField
                fullWidth
                variant="outlined"
                label="Search Advanced Training Programs"
                value={searchTerm}
...
export default AdvancedTrainingPrograms;
